...
This was a left rotation (because root element of a subtree moved to the left), but a right rotation is mirror of this. This generalized formula works for all but one case which we'll examine now.
