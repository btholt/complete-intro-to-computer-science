...
Click the above button and it will take you to a ready-to-go CodeSandbox. I will suggest that you sign up for your own and then fork my CodeSandbox so you can keep a copy of the code you write for yourself.
...
There is a console built into CodeSandbox, I'd suggest using that. It's a lot less noisy. Click here to access it.
